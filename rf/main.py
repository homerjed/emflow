...
def get_score_y_x(
    ...
    V_x_x_t = cov_t @ J_E_x_x_t / maybe_clip(alpha_t) # Eq 5 https://arxiv.org/pdf/2310.06721v3
...
def get_x_sampler(
    ...
    *,
    ...
    return lambda key: sampler(flow, sde_type=sde_type)(key)
...
if __name__ == "__main__":
    ...
    if ppca_pretrain:
        ...
        with trange(
            ...
            for s in steps:                
                ...
                l_x = -jnp.sum(jax.vmap(partial(gaussian_log_prob, mu_x=mu_x, cov_x=cov_x))(X))
    ...
    sampler = get_x_sampler(flow, sampling_mode=sampling_mode, sde_type=sde_type)
